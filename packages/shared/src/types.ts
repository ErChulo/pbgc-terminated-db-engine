...
export type StructuredIssue = {
  ...
  module_name: "date_resolution" | "service_resolution" | "compensation_resolution" | "form_resolution" | "benefit_kernel" | "v1_ve_output" | "valuation_listings_output" | "bsrs_configuration_output";
  rule_version: string;
};
