...
- [ ] T022 [P] [US2] Add failing test that every selector option has approved artifact or approved mocked-context basis in packages/tests/reconciliation-workbench-ui.test.ts
